            ...
            <div className="custom-screen__content">
              <form className="custom-login" onSubmit={handleSubmit}>
                <div className="custom-login__field">
                  <FontAwesomeIcon icon={faUser} className="icons-login-opacity"/>
                  <input
                ...
                <div className="custom-login__field">
                  <FontAwesomeIcon icon={faLock} className="icons-login-opacity"/>
                  <input
                    onChange={handleChange}
                  ...
                  />
                  <FontAwesomeIcon
                    className="cursor-pointer icons-login-opacity"
              ...
              <div className="custom-social-login">
                <div className="custom-social-icons">
                  <Link
                    href="#"
                    className="custom-social-login__icon circle-white-icon me-2"
                  >
                    <svg
                  ...
                  <Link
                    href="#"
                    className="custom-social-login__icon circle-white-icon"
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      x="0px"
