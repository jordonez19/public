...
const Banner = () => {
  ...
  return (
    <>
      <img className="fadeIn shape-banner d-none d-md-block" src="/banner/hero-shape.png" loading="lazy" alt="Hero shape" />
      <img className="fadeIn shape-banner-left" src="/banner/blur-layer.png" loading="lazy" alt="Blur layer" />
      <img className="fadeIn shape-banner-bottom" src="/banner/half-circle.png" loading="lazy" alt="Half circle" />
      <img className="fadeIn banner-people_team" src="/banner/people_team.png" loading="lazy" alt="People team" />
